    ...
    <form action="{{ route('post.update', $post->id) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <select id="category" name="category"
                ...
                <option value="lifestyle" @if(old('catgory',$post->category)=='lifestyle') selected @endif>Lifestyle</option>
                <o value="travel" @if(old('category',$post->category) == 'travel') selected @endif>Travel</option>
        ...
        <div>
            <img id="featuredImageDisplay" src="{{ asset($post->featured_image) }}" alt="Featured Image" class="w-64">
        </div>
        <div class="mb-4">
